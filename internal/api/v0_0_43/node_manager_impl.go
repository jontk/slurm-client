...
func (m *NodeManagerImpl) List(ctx context.Context, opts *interfaces.ListNodesOptions) (*interfaces.NodeList, error) {
	...
	flags := SlurmV0043GetNodesParamsFlagsDETAIL
	params.Flags = &flags

	// Call the generated OpenAPI client
	resp, err := m.client.apiClient.SlurmV0043GetNodesWithResponse(ctx, params)
	if err != nil {
...
func convertAPINodeToInterface(apiNode V0043Node) (*interfaces.Node, error) {
	...
	if apiNode.State != nil && len(*apiNode.State) > 0 {
		node.State = string((*apiNode.State)[0])
	}
	...
	// Partitions - V0043CsvString (which is []string)
	...
	// Features - V0043CsvString (which is []string)
...
func (m *NodeManagerImpl) Get(ctx context.Context, nodeName string) (*interfaces.Node, error) {
	...
	// Prepare parameters for the API call
	params := &SlurmV0043GetNodeParams{}

	// Set flags to get detailed node information
	flags := SlurmV0043GetNodeParamsFlagsDETAIL
	params.Flags = &flags

	// Call the generated OpenAPI client
	resp, err := m.client.apiClient.SlurmV0043GetNodeWithResponse(ctx, nodeName, params)
	if err != nil {
		wrappedErr := errors.WrapError(err)
		return nil, errors.EnhanceErrorWithVersion(wrappedErr, "v0.0.43")
	}
...
func (m *NodeManagerImpl) Update(ctx context.Context, nodeName string, update *interfaces.NodeUpdate) error {
	...
	// Call the generated OpenAPI client
	resp, err := m.client.apiClient.SlurmV0043PostNodeWithResponse(ctx, nodeName, *nodeUpdate)
	if err != nil {
		wrappedErr := errors.WrapError(err)
...
// convertNodeUpdateToAPI converts interfaces.NodeUpdate to V0043UpdateNodeMsg
func convertNodeUpdateToAPI(update *interfaces.NodeUpdate) (*V0043UpdateNodeMsg, error) {
	if update == nil {
		return nil, errors.NewClientError(errors.ErrorCodeInvalidRequest, "Node update cannot be nil")
	}

	nodeUpdate := &V0043UpdateNodeMsg{}

	// Set node state if provided
	if update.State != nil {
		// Convert state string to V0043UpdateNodeMsgState array
		stateStr := V0043UpdateNodeMsgState(*update.State)
		state := []V0043UpdateNodeMsgState{stateStr}
