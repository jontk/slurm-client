...
// ResponseAdapter implements common.ErrorResponse for v0.0.43 responses
type ResponseAdapter struct {
	statusCode int
	errors     *V0043OpenapiErrors
}

// NewResponseAdapter creates a new response adapter
func NewResponseAdapter(statusCode int, errors *V0043OpenapiErrors) *ResponseAdapter {
