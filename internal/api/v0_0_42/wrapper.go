...
// WrapperClient implements the SlurmClient interface for API version v0.0.42
type WrapperClient struct {
	apiClient *ClientWithResponses
	config    *interfaces.ClientConfig
}

// NewWrapperClient creates a new v0.0.42 client
...
func (c *WrapperClient) Clusters() interfaces.ClusterManager {
	return &common.ClusterManagerStub{Version: "v0.0.42"}
}

// Associations returns the AssociationManager (stub - not supported in v0.0.42)
func (c *WrapperClient) Associations() interfaces.AssociationManager {
	return &common.AssociationManagerStub{Version: "v0.0.42"}
}

// WCKeys returns the WCKeyManager (stub - not supported in v0.0.42)
