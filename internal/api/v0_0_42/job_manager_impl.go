...
func (m *JobManagerImpl) List(ctx context.Context, opts *interfaces.ListJobsOptions) (*interfaces.JobList, error) {
	...
	if resp.StatusCode() != 200 {
		...
		httpErr := errors.WrapHTTPError(resp.StatusCode(), resp.Body, "v0.0.42")
		return nil, httpErr
	}
...
func convertAPIJobToInterface(apiJob V0042JobInfo) *interfaces.Job {
	job := &interfaces.Job{}
...
func (m *JobManagerImpl) Signal(ctx context.Context, jobID string, signal string) error {
	return errors.NewNotImplementedError("Signal", "v0.0.42")
}
