...
// ResponseAdapter implements common.ErrorResponse for v0.0.40 responses
type ResponseAdapter struct {
	statusCode int
	errors     *V0040OpenapiErrors
}

// NewResponseAdapter creates a new response adapter
func NewResponseAdapter(statusCode int, errors *V0040OpenapiErrors) *ResponseAdapter {
