...
// JobManager implements factory.JobManager for API version v0.0.41
...
// NodeManager implements factory.NodeManager for API version v0.0.41
...
func (n *NodeManager) Get(ctx context.Context, nodeName string) (*factory.Node, error) {
	resp, err := n.client.apiClient.SlurmV0041GetNodeWithResponse(ctx, nodeName, nil)
	if err != nil {
...
// PartitionManager implements factory.PartitionManager for API version v0.0.41
...
func (p *PartitionManager) Get(ctx context.Context, partitionName string) (*factory.Partition, error) {
	resp, err := p.client.apiClient.SlurmV0041GetPartitionWithResponse(ctx, partitionName, nil)
	if err != nil {
...
// InfoManager implements factory.InfoManager for API version v0.0.41
...
func (i *InfoManager) Ping(ctx context.Context) error {
	resp, err := i.client.apiClient.SlurmV0041GetPingWithResponse(ctx)
	if err != nil {
...
func convertJobFromAPI(apiJob V0041Job) factory.Job {
	job := factory.Job{
...
func convertJobSubmissionToAPI(submission *factory.JobSubmission) V0041JobSubmitReq {
	apiSubmission := V0041JobSubmitReq{}
...
func convertNodeFromAPI(apiNode V0041Node) factory.Node {
	node := factory.Node{
		Metadata: make(map[string]interface{}),
	}
...
func convertPartitionFromAPI(apiPartition V0041Partition) factory.Partition {
