...
// goverter:extend ConvertJobPriorityByPartition
// goverter:extend ConvertJobStepID
// goverter:extend ConvertJobGRESDetail
// goverter:extend ConvertJobResources
type JobConverterGoverter interface {
	// ConvertAPIJobToCommon converts API V0044JobInfo to common Job type
	//
	...
	// goverter:map PriorityByPartition | ConvertJobPriorityByPartition
	// goverter:map StepId StepID | ConvertJobStepID
	...
	ConvertAPIJobToCommon(source api.V0044JobInfo) *types.Job
}
