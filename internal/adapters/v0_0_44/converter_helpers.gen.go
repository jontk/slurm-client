...
func convertResumeAfter(apiResume *api.V0044Uint64NoValStruct) *uint64 {
...
func convertNodeEnergy(apiEnergy *api.V0044AcctGatherEnergy) *types.NodeEnergy {
	if apiEnergy == nil {
		return nil
	}
...
func convertAssocShortSlice(apiAssocs *api.V0044AssocShortList) []types.AssocShort {
	if apiAssocs == nil {
		return nil
	}
