...
// This converts API V0044ReservationInfo to the common types.Reservation type.
// goverter:converter
...
type ReservationConverterGoverter interface {
	// ConvertAPIReservationToCommon converts API V0044ReservationInfo to common Reservation type
	//
	...
	ConvertAPIReservationToCommon(source api.V0044ReservationInfo) *types.Reservation
}
