...
// NodeAdapter implements the NodeAdapter interface for v0.0.44
...
// NewNodeAdapter creates a new Node adapter for v0.0.44
func NewNodeAdapter(client *api.ClientWithResponses) *NodeAdapter {
	return &NodeAdapter{
		BaseManager: base.NewBaseManager("v0.0.44", "Node"),
		client:      client,
...
func (a *NodeAdapter) Update(ctx context.Context, nodeName string, update *types.NodeUpdate) error {
	...
	reqBody := api.SlurmV0044PostNodeJSONRequestBody{
...
func (a *NodeAdapter) Drain(ctx context.Context, nodeName string, reason string) error {
	// v0.0.44 supports drain operations through the Update method
...
func (a *NodeAdapter) Resume(ctx context.Context, nodeName string) error {
	// v0.0.44 supports resume operations through the Update method
