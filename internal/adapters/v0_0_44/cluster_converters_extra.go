...
func (a *ClusterAdapter) enhanceClusterWithSkippedFields(cluster *types.Cluster, apiCluster api.V0044ClusterRec) {
	if cluster == nil {
		return
	}
...
func convertClusterFlags(apiFlags *[]api.V0044ClusterRecFlags) []types.ClusterControllerFlagsValue {
...
func convertTRESList(apiTRES *api.V0044TresList) []types.TRES {
