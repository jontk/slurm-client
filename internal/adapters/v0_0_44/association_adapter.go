...
// NewAssociationAdapter creates a new Association adapter for v0.0.44
func NewAssociationAdapter(client *api.ClientWithResponses) *AssociationAdapter {
	return &AssociationAdapter{
		BaseManager: base.NewBaseManager("v0.0.44", "Association"),
		client:      client,
...
func (a *AssociationAdapter) Create(ctx context.Context, association *types.AssociationCreate) (*types.AssociationCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0044PostAssociationsJSONRequestBody{
		Associations: []api.V0044Assoc{*apiAssoc},
	}
	...
	return &types.AssociationCreateResponse{
		Status:  "success",
		Message: fmt.Sprintf("Association created for account %s, user %s, cluster %s", association.AccountName, association.UserName, association.Cluster),
	}, nil
}
...
func (a *AssociationAdapter) Delete(ctx context.Context, associationID string) error {
	...
	// Call the generated OpenAPI client
	resp, err := a.client.SlurmdbV0044DeleteAssociationWithResponse(ctx, &api.SlurmdbV0044DeleteAssociationParams{})
	if err != nil {
		return a.HandleAPIError(err)
	}
