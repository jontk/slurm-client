...
type MockWCKeyClient struct {
	CreateFunc func(ctx context.Context, body api.V0044OpenapiWckeyResp, reqEditors ...api.RequestEditorFn) (*http.Response, error)
	ListFunc   func(ctx context.Context, params *api.SlurmdbV0044GetWckeysParams, reqEditors ...api.RequestEditorFn) (*http.Response, error)
	DeleteFunc func(ctx context.Context, wckey string, reqEditors ...api.RequestEditorFn) (*http.Response, error)
}
