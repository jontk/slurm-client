...
// AccountAdapter implements the Account adapter interface for v0_0_44
...
func NewAccountAdapter(client *api.ClientWithResponses) *AccountAdapter {
	return &AccountAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.44", "Account"),
		client:      client,
	}
}
...
func (a *AccountAdapter) Create(ctx context.Context, input *types.AccountCreate) (*types.AccountCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0044PostAccountsJSONRequestBody{
		Accounts: []api.V0044Account{*apiInput},
	}
