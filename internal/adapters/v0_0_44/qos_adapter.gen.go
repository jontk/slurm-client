...
// QoSAdapter implements the QoS adapter interface for v0_0_44
...
func NewQoSAdapter(client *api.ClientWithResponses) *QoSAdapter {
	return &QoSAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.44", "QoS"),
		client:      client,
	}
}
...
func (a *QoSAdapter) Create(ctx context.Context, input *types.QoSCreate) (*types.QoSCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0044PostQosJSONRequestBody{
		Qos: []api.V0044Qos{*apiInput},
	}
	// Call the API (params is nil for default behavior)
	resp, err := a.client.SlurmdbV0044PostQosWithResponse(ctx, nil, reqBody)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
	// Handle response errors
