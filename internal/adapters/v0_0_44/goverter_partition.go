...
type PartitionConverterGoverter interface {
	// ConvertAPIPartitionToCommon converts API V0044PartitionInfo to common Partition type
	...
	ConvertAPIPartitionToCommon(source api.V0044PartitionInfo) *types.Partition
}
