...
// NewQoSAdapter creates a new QoS adapter for v0.0.44
func NewQoSAdapter(client *api.ClientWithResponses) *QoSAdapter {
	...
	return &QoSAdapter{
		QoSBaseManager: base.NewQoSBaseManager("v0.0.44"),
		client:         client,
...
func (a *QoSAdapter) List(ctx context.Context, opts *types.QoSListOptions) (*types.QoSList, error) {
	...
	resp, err := a.client.SlurmdbV0044GetQosWithResponse(ctx, params)
	if err != nil {
...
func (a *QoSAdapter) Get(ctx context.Context, qosName string) (*types.QoS, error) {
	...
	// Call the generated OpenAPI client
	resp, err := a.client.SlurmdbV0044GetSingleQosWithResponse(ctx, qosName, params)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
...
func (a *QoSAdapter) Create(ctx context.Context, qos *types.QoSCreate) (*types.QoSCreateResponse, error) {
	...
	// Call the generated OpenAPI client
	resp, err := a.client.SlurmdbV0044PostQosWithResponse(ctx, params, reqBody)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
...
func (a *QoSAdapter) Delete(ctx context.Context, qosName string) error {
	...
	// Call the generated OpenAPI client
	resp, err := a.client.SlurmdbV0044DeleteSingleQosWithResponse(ctx, qosName)
	if err != nil {
		return a.HandleAPIError(err)
	}
