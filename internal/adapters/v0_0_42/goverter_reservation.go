...
// This converts API V0042ReservationInfo to the common types.Reservation type.
// goverter:converter
...
type ReservationConverterGoverter interface {
	// ConvertAPIReservationToCommon converts API V0042ReservationInfo to common Reservation type
	//
	...
	ConvertAPIReservationToCommon(source api.V0042ReservationInfo) *types.Reservation
}
