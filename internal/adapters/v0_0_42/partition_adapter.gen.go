...
// PartitionAdapter implements the Partition adapter interface for v0_0_42
...
func NewPartitionAdapter(client *api.ClientWithResponses) *PartitionAdapter {
	return &PartitionAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.42", "Partition"),
		client:      client,
	}
}
...
func (a *PartitionAdapter) Get(ctx context.Context, partitionName string) (*types.Partition, error) {
	...
	// Call the API
	resp, err := a.client.SlurmV0042GetPartitionWithResponse(ctx, partitionName, params)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
	// Handle response errors
