...
func (a *NodeAdapter) convertCommonNodeUpdateToAPI(input *types.NodeUpdate) *api.V0042Node {
	return nil
}
...
func (s *stubJobWriteConverter) ConvertCommonJobCreateToAPI(source *types.JobCreate) *api.V0042JobDescMsg {
	return nil
}
...
func (s *stubNodeWriteConverter) ConvertCommonNodeUpdateToAPI(source *types.NodeUpdate) *api.V0042UpdateNodeMsg {
	return nil
}
