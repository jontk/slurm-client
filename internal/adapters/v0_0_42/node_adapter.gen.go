...
// NodeAdapter implements the Node adapter interface for v0_0_42
...
func NewNodeAdapter(client *api.ClientWithResponses) *NodeAdapter {
	return &NodeAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.42", "Node"),
		client:      client,
	}
}
...
func (a *NodeAdapter) Get(ctx context.Context, nodeName string) (*types.Node, error) {
	...
	// Call the API
	resp, err := a.client.SlurmV0042GetNodeWithResponse(ctx, nodeName, params)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
	// Handle response errors
...
func (a *NodeAdapter) Update(ctx context.Context, nodeName string, update *types.NodeUpdate) error {
	...
	resp, err := a.client.SlurmV0042PostNodeWithResponse(ctx, nodeName, reqBody)
	if err != nil {
...
func (a *NodeAdapter) Delete(ctx context.Context, nodeName string) error {
	...
	// Call the API
	resp, err := a.client.SlurmV0042DeleteNodeWithResponse(ctx, nodeName)
	if err != nil {
		return a.HandleAPIError(err)
	}
	// Handle response errors
