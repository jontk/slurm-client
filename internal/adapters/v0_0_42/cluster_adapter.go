...
// ClusterAdapter implements the ClusterAdapter interface for v0.0.42
type ClusterAdapter struct {
	*base.BaseManager
	client *api.ClientWithResponses
}

// NewClusterAdapter creates a new Cluster adapter for v0.0.42
...
func (a *ClusterAdapter) List(ctx context.Context, opts *types.ClusterListOptions) (*types.ClusterList, error) {
	...
	params := &api.SlurmdbV0042GetClustersParams{}
	...
	// Call the API
	resp, err := a.client.SlurmdbV0042GetClustersWithResponse(ctx, params)
	if err != nil {
...
func (a *ClusterAdapter) Get(ctx context.Context, clusterName string) (*types.Cluster, error) {
	...
	// Prepare parameters for the API call
	params := &api.SlurmdbV0042GetClusterParams{}

	// Call the API
	resp, err := a.client.SlurmdbV0042GetClusterWithResponse(ctx, clusterName, params)
	if err != nil {
...
func (a *ClusterAdapter) Create(ctx context.Context, cluster *types.ClusterCreate) (*types.ClusterCreateResponse, error) {
	...
	// Create request body
	apiReq := api.V0042OpenapiClustersResp{
		Clusters: []api.V0042ClusterRec{*apiCluster},
	}

	// Call the API
	params := &api.SlurmdbV0042PostClustersParams{}
	resp, err := a.client.SlurmdbV0042PostClustersWithResponse(ctx, params, apiReq)
	if err != nil {
	...
	// Convert response - v0.0.42 POST returns V0042OpenapiResp not V0042OpenapiClustersResp
...
func (a *ClusterAdapter) Delete(ctx context.Context, clusterName string) error {
	...
	// Prepare parameters for the API call
	params := &api.SlurmdbV0042DeleteClusterParams{}

	// Call the API
	resp, err := a.client.SlurmdbV0042DeleteClusterWithResponse(ctx, clusterName, params)
	if err != nil {
...
func (a *ClusterAdapter) convertAPIClusterToCommon(apiCluster api.V0042ClusterRec) (*types.Cluster, error) {
...
func (a *ClusterAdapter) convertAPIClusterCreateResponseToCommon(apiResp *api.V0042OpenapiResp, name string) (*types.ClusterCreateResponse, error) {
	...
	// V0042OpenapiResp doesn't contain clusters - it's a general response
	// We cannot extract details from the response for v0.0.42
...
func (a *ClusterAdapter) extractMeta(meta *api.V0042OpenapiMeta) map[string]interface{} {
