...
// WCKeyAdapter implements the WCKey adapter interface for v0_0_42
...
func NewWCKeyAdapter(client *api.ClientWithResponses) *WCKeyAdapter {
	return &WCKeyAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.42", "WCKey"),
		client:      client,
	}
}
...
func (a *WCKeyAdapter) Get(ctx context.Context, wckeyName string) (*types.WCKey, error) {
	...
	resp, err := a.client.SlurmdbV0042GetWckeyWithResponse(ctx, wckeyName)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
...
func (a *WCKeyAdapter) Create(ctx context.Context, input *types.WCKeyCreate) (*types.WCKeyCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0042PostWckeysJSONRequestBody{
		Wckeys: []api.V0042Wckey{*apiInput},
	}

	// Call the API (params is nil for default behavior)
	resp, err := a.client.SlurmdbV0042PostWckeysWithResponse(ctx, nil, reqBody)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
...
func (a *WCKeyAdapter) Delete(ctx context.Context, wckeyName string) error {
	...
	// Call the API
	resp, err := a.client.SlurmdbV0042DeleteWckeyWithResponse(ctx, wckeyName)
	if err != nil {
