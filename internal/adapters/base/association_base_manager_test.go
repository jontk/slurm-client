...
func TestAssociationBaseManager_FilterAssociationList(t *testing.T) {
	...
	associations := []types.Association{
		{Account: stringPtr("account1"), User: "user1", Cluster: stringPtr("cluster1")},
		{Account: stringPtr("account2"), User: "user2", Cluster: stringPtr("cluster1")},
		{Account: stringPtr("account1"), User: "user1", Cluster: stringPtr("cluster2")},
	}
	tests := []struct {
		name     string
