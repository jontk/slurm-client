...
func (a *JobAdapter) convertCommonJobUpdateToAPI(existing *types.Job, update *types.JobUpdate) *api.V0043Job {
	apiJob := &api.V0043Job{}
...
func (a *JobAdapter) convertCommonJobAllocateToAPI(req *types.JobAllocateRequest) *api.V0043JobAllocReq {
