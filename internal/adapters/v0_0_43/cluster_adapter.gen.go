...
// ClusterAdapter implements the Cluster adapter interface for v0_0_43
...
func NewClusterAdapter(client *api.ClientWithResponses) *ClusterAdapter {
	return &ClusterAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.43", "Cluster"),
		client:      client,
	}
}
...
func (a *ClusterAdapter) Create(ctx context.Context, input *types.ClusterCreate) (*types.ClusterCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0043PostClustersJSONRequestBody{
		Clusters: []api.V0043ClusterRec{*apiInput},
	}

	// Call the API (params is nil for default behavior)
	resp, err := a.client.SlurmdbV0043PostClustersWithResponse(ctx, nil, reqBody)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
...
func (a *ClusterAdapter) Delete(ctx context.Context, clusterName string) error {
	...
	// Call the API (params is nil for default behavior)
	resp, err := a.client.SlurmdbV0043DeleteClusterWithResponse(ctx, clusterName, nil)
	if err != nil {
