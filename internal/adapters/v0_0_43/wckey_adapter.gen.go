...
// WCKeyAdapter implements the WCKey adapter interface for v0_0_43
...
func NewWCKeyAdapter(client *api.ClientWithResponses) *WCKeyAdapter {
	return &WCKeyAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.43", "WCKey"),
		client:      client,
	}
}
...
func (a *WCKeyAdapter) Get(ctx context.Context, wckeyName string) (*types.WCKey, error) {
	...
	resp, err := a.client.SlurmdbV0043GetWckeyWithResponse(ctx, wckeyName)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
	// Handle response errors
...
func (a *WCKeyAdapter) Create(ctx context.Context, input *types.WCKeyCreate) (*types.WCKeyCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0043PostWckeysJSONRequestBody{
		Wckeys: []api.V0043Wckey{*apiInput},
	}
	// Call the API (params is nil for default behavior)
	resp, err := a.client.SlurmdbV0043PostWckeysWithResponse(ctx, nil, reqBody)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
	// Handle response errors
...
func (a *WCKeyAdapter) Delete(ctx context.Context, wckeyName string) error {
	...
	// Call the API
	resp, err := a.client.SlurmdbV0043DeleteWckeyWithResponse(ctx, wckeyName)
	if err != nil {
