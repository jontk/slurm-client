...
func (a *UserAdapter) convertAPIUserToCommon(apiUser api.V0043User) *types.User {
	user := &types.User{
	...
	if apiUser.AdministratorLevel != nil && len(*apiUser.AdministratorLevel) > 0 {
		...
		switch adminLevel {
		case api.V0043UserAdministratorLevelAdministrator:
			user.AdminLevel = types.AdminLevelAdministrator
		case api.V0043UserAdministratorLevelOperator:
			user.AdminLevel = types.AdminLevelOperator
		case api.V0043UserAdministratorLevelNone, api.V0043UserAdministratorLevelNotSet:
...
func (a *UserAdapter) convertCommonUserCreateToAPI(create *types.UserCreate) *api.V0043User {
...
func (a *UserAdapter) convertCommonUserUpdateToAPI(existing *types.User, update *types.UserUpdate) *api.V0043User {
	apiUser := &api.V0043User{
...
func (a *UserAdapter) convertCommonUserAssociationToAPI(req *types.UserAssociationRequest) []api.V0043Assoc {
