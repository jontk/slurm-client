...
// NodeAdapter implements the Node adapter interface for v0_0_43
...
func NewNodeAdapter(client *api.ClientWithResponses) *NodeAdapter {
	return &NodeAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.43", "Node"),
		client:      client,
	}
}
...
func (a *NodeAdapter) Update(ctx context.Context, nodeName string, update *types.NodeUpdate) error {
	...
	resp, err := a.client.SlurmV0043PostNodeWithResponse(ctx, nodeName, reqBody)
	if err != nil {
