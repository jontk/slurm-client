...
// QoSAdapter implements the QoS adapter interface for v0_0_43
...
func NewQoSAdapter(client *api.ClientWithResponses) *QoSAdapter {
	return &QoSAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.43", "QoS"),
		client:      client,
	}
}
...
func (a *QoSAdapter) Create(ctx context.Context, input *types.QoSCreate) (*types.QoSCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0043PostQosJSONRequestBody{
		Qos: []api.V0043Qos{*apiInput},
	}

	// Call the API (params is nil for default behavior)
	resp, err := a.client.SlurmdbV0043PostQosWithResponse(ctx, nil, reqBody)
	if err != nil {
		return nil, a.HandleAPIError(err)
	}
