...
func convertResumeAfter(apiResume *api.V0043Uint64NoValStruct) *uint64 {
...
func convertNodeEnergy(apiEnergy *api.V0043AcctGatherEnergy) *types.NodeEnergy {
	if apiEnergy == nil {
		return nil
	}
...
func convertAssocShortSlice(apiAssocs *api.V0043AssocShortList) []types.AssocShort {
	if apiAssocs == nil {
		return nil
	}
