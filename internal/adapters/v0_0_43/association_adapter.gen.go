...
// AssociationAdapter implements the Association adapter interface for v0_0_43
...
func NewAssociationAdapter(client *api.ClientWithResponses) *AssociationAdapter {
	return &AssociationAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.43", "Association"),
		client:      client,
	}
}
...
func (a *AssociationAdapter) Create(ctx context.Context, input *types.AssociationCreate) (*types.AssociationCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0043PostAssociationsJSONRequestBody{
		Associations: []api.V0043Assoc{*apiInput},
	}
...
func (a *AssociationAdapter) Delete(ctx context.Context, associationID string) error {
	...
	resp, err := a.client.SlurmdbV0043DeleteAssociationWithResponse(ctx, &api.SlurmdbV0043DeleteAssociationParams{Id: &associationID})
	if err != nil {
		return a.HandleAPIError(err)
	}
