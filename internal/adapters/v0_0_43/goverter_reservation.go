...
// This converts API V0043ReservationInfo to the common types.Reservation type.
// goverter:converter
...
type ReservationConverterGoverter interface {
	// ConvertAPIReservationToCommon converts API V0043ReservationInfo to common Reservation type
	//
	...
	ConvertAPIReservationToCommon(source api.V0043ReservationInfo) *types.Reservation
}
