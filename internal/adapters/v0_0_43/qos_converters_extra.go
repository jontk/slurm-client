...
func (a *QoSAdapter) enhanceQoSWithSkippedFields(result *types.QoS, apiObj api.V0043Qos) {
	if result == nil {
		return
	}
	// Flags
...
func convertAPITresListToCommon(apiTres api.V0043TresList) []types.TRES {
	if len(apiTres) == 0 {
		return nil
	}
