...
func (a *UserAdapter) enhanceUserWithSkippedFields(result *types.User, apiObj api.V0043User) {
	if result == nil {
		return
	}
	// AdministratorLevel
...
func convertAPIAssocShortListToCommon(apiList api.V0043AssocShortList) []types.AssocShort {
	if len(apiList) == 0 {
		return nil
	}
...
func convertAPICoordListToCommon(apiList api.V0043CoordList) []types.Coord {
	if len(apiList) == 0 {
		return nil
	}
...
func convertAPIWckeyListToCommon(apiList api.V0043WckeyList) []types.WCKey {
	if len(apiList) == 0 {
		return nil
	}
...
func convertAPIAccountingListToCommon(apiList api.V0043AccountingList) []types.Accounting {
	if len(apiList) == 0 {
		return nil
	}
