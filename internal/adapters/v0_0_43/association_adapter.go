...
func (a *AssociationAdapter) convertAPIAssociationToCommon(apiAssociation api.V0043Assoc) *types.Association {
...
func (a *AssociationAdapter) convertCommonAssociationCreateToAPI(create *types.AssociationCreate) *api.V0043Assoc {
...
func (a *AssociationAdapter) convertCommonAssociationUpdateToAPI(existing *types.Association) *api.V0043Assoc {
	apiAssociation := &api.V0043Assoc{}
