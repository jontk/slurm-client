...
// AccountAdapter implements the Account adapter interface for v0_0_43
...
func NewAccountAdapter(client *api.ClientWithResponses) *AccountAdapter {
	return &AccountAdapter{
		BaseManager: adapterbase.NewBaseManager("v0.0.43", "Account"),
		client:      client,
	}
}
...
func (a *AccountAdapter) Create(ctx context.Context, input *types.AccountCreate) (*types.AccountCreateResponse, error) {
	...
	reqBody := api.SlurmdbV0043PostAccountsJSONRequestBody{
		Accounts: []api.V0043Account{*apiInput},
	}
