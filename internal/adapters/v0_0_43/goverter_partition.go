...
type PartitionConverterGoverter interface {
	// ConvertAPIPartitionToCommon converts API V0043PartitionInfo to common Partition type
	...
	ConvertAPIPartitionToCommon(source api.V0043PartitionInfo) *types.Partition
}
