...
func (a *ClusterAdapter) enhanceClusterWithSkippedFields(cluster *types.Cluster, apiCluster api.V0043ClusterRec) {
	if cluster == nil {
		return
	}
...
func convertClusterFlags(apiFlags *[]api.V0043ClusterRecFlags) []types.ClusterControllerFlagsValue {
...
func convertTRESList(apiTRES *api.V0043TresList) []types.TRES {
