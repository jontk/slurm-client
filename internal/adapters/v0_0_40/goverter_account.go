...
type AccountConverterGoverter interface {
	// ConvertAPIAccountToCommon converts API V0040Account to common Account type
	...
	ConvertAPIAccountToCommon(source api.V0040Account) *types.Account
	// ConvertCommonAccountCreateToAPI converts common AccountCreate to API V0040Account type
	// goverter:map Coordinators | ConvertCoordNamesToSlice
	// goverter:ignore Associations
	// goverter:ignore Flags
	ConvertCommonAccountCreateToAPI(source *types.AccountCreate) *api.V0040Account
}
